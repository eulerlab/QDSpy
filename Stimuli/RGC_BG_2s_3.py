...
#
QDS.DefObj_Ellipse(1, p["dxStim_um"], p["dxStim_um"] /2)
QDS.DefObj_Ellipse(2, p["dxStim_um"] /2, p["dxStim_um"])
...
for iT in range(p["nTrials"]):
  ...
  QDS.SetObjColor (1, [2], [p["RGB_blue"]])
  QDS.Scene_Render(durMarker_s, 1, [2], [(0,0)], 1)
  QDS.Scene_Render(2.0-durMarker_s, 1, [2], [(0,0)], 0)
