...
def box2vert(_ob, _iob, _sc, _Stage, _stim, _nextiV):
    ...
    newVert = [rect[0], rect[1], rect[2], rect[1], rect[2], rect[3], rect[0], rect[3]]
    ...
    if _ob[stm.SO_field_doRGBAByVert]:
        newRGBA = (
            spp.scaleRGB(_stim, _ob[stm.SO_field_fgRGB][0][0:4])
        ...
        newRGBA2 = (
            spp.scaleRGB(_stim, _ob[stm.SO_field_fgRGB][0][4:8])
...
def marker2vert(_Stage, _Conf):
    ...
    return rdr.vertFromRect(
        [-dx2, -dx2, dx2, dx2], pxy, _Conf.markRGBA
