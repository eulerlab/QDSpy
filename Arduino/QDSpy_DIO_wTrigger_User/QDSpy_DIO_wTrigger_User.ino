...
#define  pin_USER_OUT1 3        // User out pin
#define  pin_USER_OUT2 4        // User out pin
...
void setup() 
{
  ...
  pinMode(pin_USER_OUT1, OUTPUT);    
  pinMode(pin_USER_OUT2, OUTPUT);    
...
void serialEvent()
{
  ...
  while (Serial.available()) {
    ...
    if(ch == '1') {
      ...
      digitalWrite(pin_USER_OUT1, true);
    } else if(ch == '2')  {
      digitalWrite(pin_USER_OUT1, false);
    } else if(ch == '4')  {
      digitalWrite(pin_USER_OUT2, true);
    } else if(ch == '5')  {
      digitalWrite(pin_USER_OUT2, false);
    }  
  }
}
